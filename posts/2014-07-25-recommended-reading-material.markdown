...
Alternatively, the order can be reversed: Awodey can be used as a forcing function to read Lawvere
and Mac Lane can be used as a forcing function to read Awodey.
